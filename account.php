			        		...
			        		<div class="box">
				        		...
				        		<div class="row">
									<div class="form-group circle-checkboxes col-md-12">
										<input type="checkbox" id="use_for_1" value="Medical" name="use_for[]">
										<label for="use_for_1">Medical</label>

										<input type="checkbox" id="use_for_2" value="Grower" name="use_for[]">
										<label for="use_for_2">Grower</label>

										<input type="checkbox" id="use_for_3" value="Doctor" name="use_for[]">
										<label for="use_for_3">Doctor</label>

										<input type="checkbox" id="use_for_4" value="Adult use" name="use_for[]">
